...
const CopyColor = ({ copyTheColor }) => {
  ...
  return (
    <div
      className="copycolor fixed inset-0 flex items-center justify-center text-white transition-opacity ease-in-out duration-300 z-50 pointer-events-none lefttoright"
